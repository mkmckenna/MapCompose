...
[![](https://img.shields.io/badge/ComposeBOM-2026.05.01-brightgreen)](https://developer.android.com/jetpack/compose/bom/bom)

🎉 News:
- [MapCompose Multiplatform](https://github.com/p-lr/MapComposeMP) `1.0.0` is officially released.
...
```groovy
implementation 'ovh.plrapps:mapcompose:3.2.8'
```
